...
visit2 = Visits(user_id=user1.id, beacon_id=beacon2.id, time_entered=datetime.datetime(2014, 03, 2, 11, 45, 0), time_left=datetime.datetime(2014, 03, 2, 12, 45, 0))
...
visit5 = Visits(user_id=user2.id, beacon_id=beacon2.id, time_entered=datetime.datetime(2014, 03, 2, 11, 45, 0), time_left=datetime.datetime(2014, 03, 2, 12, 45, 0))
